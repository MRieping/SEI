...
$(document).ready(function templating_add() {
    ...
    $('#btn_add_new_sensor').click(function(){
        ...
        console.log("Try to change template to 'template_add_sensor'");
        
        get_locations(
            '#add_table_location_body', 
            ['location_name'],
            0,
            'all_locations'
        );
    ...
    $('#btn_add_new_harddisk').click(function(){
        ...
        $('#main_container').load('templates/templates_add/template_add_harddisk.html');
    });
});
...
function templating_add_sending(add_alert, product) {
    ...
    if(product.selected_location === undefined) {
        ...
        $(add_alert).fadeIn();
        setTimeout(function () {$(add_alert).fadeOut();}, 7342);
